...
-- The API sets app.current_tenant_id and app.current_user_role inside a transaction
-- and switches to the dedicated moby_app role for authenticated and internal service flows.
